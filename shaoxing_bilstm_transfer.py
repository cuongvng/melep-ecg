...
def experiment_bilstm_shaoxing(model_name, pretrained_checkpoint, source_data, source_labels):
...
def main():
    ...
    for source_data in SOURCE_LABELS.keys():
        ...
        experiment_bilstm_shaoxing(model_name, pretrained_checkpoint, source_data, source_labels)
