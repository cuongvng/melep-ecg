...
def experiment_ptbxl(model_name, pretrained_checkpoint, source_data, source_labels):
...
def main():
    ...
    for model_name in MODELS:
        for source_data in SOURCE_LABELS.keys():
            ...
            experiment_ptbxl(model_name, pretrained_checkpoint, source_data, source_labels)
